...
import { TextureConfig } from '@tensorflow/tfjs-backend-webgl/dist/tex_util';
...
export declare function uploadPixelDataToTexture(gl: WebGLRenderingContext, texture: WebGLTexture, pixels: PixelData | ImageData | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement): void;
